<template>
  <div>
    <ul v-if="products.length" class="grid grid-cols-2 gap-2 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4  py-9">
      <li v-for="(product, index) in products" :key="index" class="col-span-1 flex flex-col text-center bg-red-200">
        ...
        <div class=" relative">
          <div class=" inset-0  w-full">
            <img class=" w-full object-cover object-center" :src="product.image" :alt="product.name">
